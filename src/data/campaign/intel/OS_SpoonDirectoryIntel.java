...
public class OS_SpoonDirectoryIntel extends BaseIntelPlugin {
    ...
    protected void renderReviewsTab(TooltipMakerAPI info, float width, float opad, float spad) {
        ...
        info.addPara(
            "\"The Persean Sector is crawling with frauds, warlords, and self-appointed 'culinary commentators' who haven't set foot outside a Core World orbital lounge in twenty cycles—chief among them my insufferable former mess-mate, Gordon 'Transverse' Stumps. Back in Cycle 204 at Eos Exodus, I had my hand on the manual airlock override, fully prepared to vent Stumps into the cold void mid-soliloquy over 'sous-vide squab.' I only aborted because the chief engineer swore Stumps' enormous ego would clog the atmospheric intake scrubbers. This dispatch isn't for Stumps and his silk-robed sycophants. This is for the captains, engineers, and grease-monkeys living in the pressurized iron buckets hurtling through a radioactive graveyard. Eat dirty, drink deep, tip your mess attendants, and never-ever-order refrigerated seafood when the station's reactor tap is flashing amber.\"",
            Misc.getTextColor(),
            opad
        );
